...
public class TargetDummyBase extends Block{
    ...
    public UnitType unitType = EXSUnitTypes.targetDummy;
    ...
    public void setBars(){
        ...
        addBar("exs-dps", (TargetDummyBaseBuild entity) -> new Bar(
    ...
    public class TargetDummyBaseBuild extends Building implements UnitTetherBlock{
        ...
        public String displayDPS(boolean round){
            if(time > 0){
                return (round ? (DPS > 0 ? EXSUtls.round(DPS) : "---") : Strings.autoFixed(total / time * 60f, 2)) + " DPS";
            }else{
                return "--- DPS";
            }
        }
        ...
        public void buildConfiguration(Table table){
            table.table(t -> {
                ...
                t.check("@exs-target-dummy.enemy", unitTeam != team, b -> configure(dummyTeam()));
                t.row();
