...
public class SandboxWall extends Block{
    ...
    public void setStats(){
        ...
        stats.add(Stat.health, t -> t.add(EXSElements.infinity()));
    }
    ...
    public void setBars(){
        ...
        addBar("exs-dps", (SandboxWallBuild entity) -> new Bar(
    ...
    public class SandboxWallBuild extends Building{
        ...
        public void draw(){
            ...
            if(DPSTesting()){
                ...
                EXSDrawf.text(x, y, false, size * tilesize, team.color, text);
            }
        }
        ...
        public String displayDPS(boolean round){
            if(!DPSTesting()){
                ...
                return (Mathf.zero(dm) ? "Infinity" : (round ? (DPS > 0 ? EXSUtls.round(DPS) : "---") : Strings.autoFixed(total / time * 60f, 2))) + " DPS";
            }else{
                return "--- DPS";
            }
        }
        ...
        public void buildConfiguration(Table table){
            table.table(t -> {
                ...
                t.table(i -> {
                    ...
                    i.add("@exs-sandbox-wall.mode-lightning").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                    ...
                    b.table(f -> {
                        f.defaults().left();
                        addTextField(f, addColon("exs-sandbox-wall.lightning.chance"), "" + data.lightningChance, TextFieldFilter.floatsOnly, 4);
                        f.row();
                        addTextField(f, addColon("exs-sandbox-wall.lightning.damage"), "" + data.lightningDamage, TextFieldFilter.floatsOnly, 5);
                        f.row();
                        addTextField(f, addColon("exs-sandbox-wall.lightning.length"), "" + data.lightningLength, TextFieldFilter.digitsOnly, 6);
                        f.row();
                    });
                }).padLeft(32f);
                t.row();
                ...
                t.table(i -> {
                    ...
                    i.add("@exs-sandbox-wall.mode-deflection").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                    ...
                    b.table(f -> {
                        f.defaults().left();
                        addTextField(f, addColon("exs-sandbox-wall.deflection.chance"), "" + data.deflectChance, TextFieldFilter.floatsOnly, 7);
                    });
                }).padLeft(32f);
                t.row();
                ...
                t.table(i -> {
                    ...
                    i.add("@exs-sandbox-wall.mode-insulation").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                ...
                t.table(i -> {
                    ...
                    i.add("@exs-sandbox-wall.mode-dpstesting").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
