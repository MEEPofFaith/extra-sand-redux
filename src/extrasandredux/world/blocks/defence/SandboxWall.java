...
public class SandboxWall extends Block{
    ...
    public void setBars(){
        ...
        addBar("esr-dps", (SandboxWallBuild entity) -> new Bar(
    ...
    public class SandboxWallBuild extends Building{
        ...
        public String displayDPS(boolean round){
            if(!DPSTesting()){
                ...
                return (Mathf.zero(dm) ? "Infinity" : (round ? (DPS > 0 ? ESRUtls.round(DPS) : "---") : Strings.autoFixed(total / time * 60f, 2))) + " DPS";
            }else{
                return "--- DPS";
            }
        }
        ...
        public void buildConfiguration(Table table){
            table.table(Styles.black6, t -> {
                ...
                t.table(i -> {
                    ...
                    i.add("@esr-sandbox-wall.mode-lightning").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                    ...
                    b.table(f -> {
                        f.defaults().left();
                        addTextField(f, addColon("esr-sandbox-wall.lightning.chance"), "" + data.lightningChance, TextFieldFilter.floatsOnly, 4);
                        f.row();
                        addTextField(f, addColon("esr-sandbox-wall.lightning.damage"), "" + data.lightningDamage, TextFieldFilter.floatsOnly, 5);
                        f.row();
                        addTextField(f, addColon("esr-sandbox-wall.lightning.length"), "" + data.lightningLength, TextFieldFilter.digitsOnly, 6);
                        f.row();
                    });
                }).padLeft(32f);
                t.row();
                ...
                t.table(i -> {
                    ...
                    i.add("@esr-sandbox-wall.mode-deflection").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                    ...
                    b.table(f -> {
                        f.defaults().left();
                        addTextField(f, addColon("esr-sandbox-wall.deflection.chance"), "" + data.deflectChance, TextFieldFilter.floatsOnly, 7);
                    });
                }).padLeft(32f);
                t.row();
                ...
                t.table(i -> {
                    ...
                    i.add("@esr-sandbox-wall.mode-insulation").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
                ...
                t.table(i -> {
                    ...
                    i.add("@esr-sandbox-wall.mode-dpstesting").padLeft(8f);
                });
                t.row();
                t.table(b -> {
                    b.defaults().left();
