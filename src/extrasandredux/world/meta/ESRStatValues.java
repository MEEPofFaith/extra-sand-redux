package extrasandredux.world.meta;
...
public class ESRStatValues{
    public static <T extends UnlockableContent> StatValue infiniteDamageAmmo(ObjectMap<T, BulletType> map){
        return infiniteDamageAmmo(map, 0, false);
    }

    public static <T extends UnlockableContent> StatValue infiniteDamageAmmo(ObjectMap<T, BulletType> map, boolean showUnit){
        return infiniteDamageAmmo(map, 0, showUnit);
    }

    public static <T extends UnlockableContent> StatValue infiniteDamageAmmo(ObjectMap<T, BulletType> map, int indent, boolean showUnit){
        return table -> {
            ...
            for(T t : orderedKeys){
                ...
                if(type.spawnUnit != null && type.spawnUnit.weapons.size > 0){
                    infiniteDamageAmmo(ObjectMap.of(t, type.spawnUnit.weapons.first().bullet), indent, false).display(table);
                    continue;
                }
                ...
                table.table(Styles.grayPanel, bt -> {
                    ...
                    if(type.damage > 0 && (type.collides || type.splashDamage <= 0)){
                        if(type.continuousDamage() > 0){
                            ...
                            if(type.damage == Float.MAX_VALUE){
                                bt.add(ESRElements.infiniteDamage());
                            }else{
                    ...
                    if(type.intervalBullet != null){
                        ...
                        Table ic = new Table();
                        infiniteDamageAmmo(ObjectMap.of(t, type.intervalBullet), indent + 1, false).display(ic);
                    ...
                    if(type.fragBullet != null){
                        ...
                        Table fc = new Table();
                        infiniteDamageAmmo(ObjectMap.of(t, type.fragBullet), indent + 1, false).display(fc);
